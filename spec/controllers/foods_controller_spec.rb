    ...
    describe 'GET #index' do
      context 'with params[:letter]' do
    	...
    	context 'without params[:letter]' do
  		...
  		# it "populates an array of foods" do
     	#	  food = create(:food)
      #		get :index
  	...
  	describe 'POST #create' do
    	context "with valid attributes" do
          ...
          expect{
            post :create, { food: attributes_for(:invalid_food) }
      ...
      before :each do
    	...
    	context "with valid attributes" do
            ...
            patch :update, { id: @food, food: attributes_for(:food) }
            expect(assigns(:food)).to eq @food
          end

      		it "changes @food's attributes" do
            patch :update, { id: @food, food: attributes_for(:food, name: 'Nasi Uduk') }
            @food.reload
		...
		context "with invalid attributes" do
            ...
            patch :update, { id: @food, food: attributes_for(:food, name: 'Nasi Uduk', description: nil) }
            @food.reload
            expect(@food.name).not_to eq('Nasi Uduk')
          end

      		it "re-renders the :edit template" do
            patch :update, { id: @food, food: attributes_for(:invalid_food) }
            expect(response).to render_template :edit
          end
    	end
  	end
